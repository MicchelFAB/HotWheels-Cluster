...
DataManager::DataManager(QObject *parent) : QObject(parent) {
  ...
  connect(m_vehicleDataManager, &VehicleDataManager::canDataProcessed, this,
          &DataManager::canDataProcessed);
  connect(m_vehicleDataManager, &VehicleDataManager::engineDataProcessed, this,
          &DataManager::engineDataProcessed);
  connect(m_vehicleDataManager, &VehicleDataManager::mileageUpdated, this,
          &DataManager::mileageUpdated);

  // Connect signals from SystemDataManager
  connect(m_systemDataManager, &SystemDataManager::systemTimeUpdated, this,
          &DataManager::systemTimeUpdated);
  connect(m_systemDataManager, &SystemDataManager::systemWifiUpdated, this,
          &DataManager::systemWifiUpdated);
  connect(m_systemDataManager, &SystemDataManager::systemTemperatureUpdated,
          this, &DataManager::systemTemperatureUpdated);
  connect(m_systemDataManager, &SystemDataManager::ipAddressUpdated, this,
          &DataManager::ipAddressUpdated);
  connect(m_systemDataManager, &SystemDataManager::batteryPercentageUpdated,
          this, &DataManager::batteryPercentageUpdated);

  // Connect signals from ClusterSettingsManager
  connect(m_clusterSettingsManager, &ClusterSettingsManager::drivingModeUpdated,
          this, &DataManager::drivingModeUpdated);
  connect(m_clusterSettingsManager,
          &ClusterSettingsManager::clusterThemeUpdated, this,
          &DataManager::clusterThemeUpdated);
  connect(m_clusterSettingsManager,
          &ClusterSettingsManager::clusterMetricsUpdated, this,
